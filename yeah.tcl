...
set nf [open output/yeah.nam w]
$ns namtrace-all $nf
set tracefile1 [open output/yeahTrace.tr w]
$ns trace-all $tracefile1
set cwndOut [open output/yeah_cwnd.tr w]
set goodputOut [open output/yeah_goodput.tr w]
set rttOut [open output/yeah_rtt.tr w]
